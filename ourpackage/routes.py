...
from ourpackage import server


#  let's define out '/go-to-dashboard' route here:
@server.route('/go-to-dashboard')
def dashboard():
    return app.index()
...
@server.route('/users/<int:user_id>/tweets')
